...
Rails app generated with [MadzMed/tools/rails-template](https://github.com/MadzMed/tools), based on "Le wagon" template
...
after_bundle do
  ...
  ########################################
  git add: '.'
  git commit: "-m 'Initial commit with devise template from https://github.com/MadzMed/tools/rails-template.rb'"
